...
public class T2_getText_getAttribute {
    ...
    public static void main(String[] args) {
        ...
        if (actualForgotPasswordLinkText.equals(expectedForgotPasswordLinkText)){
            ...
            //aşağıdaki ilk iki sıra sonuç "Faild" cıktığında yapacağın işlem bu işlem sonucunda neyin yanlış olduğunu görürsün!!!
        ...
        //burayı pek anlamadım tekraradan bak!!!
        //5- Verify “forgot password” href attribute’s value contains expected:
        //Expected: forgot_password=yes
        String expectedInHref = "forgot_password=yes";
        String actualInHrefAttributeValue = forgotPasswordLink.getAttribute("href");

        System.out.println("actualHrefAttributuValue = "+ actualInHrefAttributeValue);
